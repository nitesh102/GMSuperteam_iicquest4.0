        ...
        <div class="py-6 space-y-6">
            ...
            <div v-if="!loading && hasItems" class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="p-4 border-b border-gray-100 space-y-3">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button
                            ...
                            @click="filterDepartment = ''; filterCategory = ''; filterStatus = ''; filterPriority = ''; search = ''"
                ...
                >
                    ...
                    <button @click="filterDepartment = ''; filterCategory = ''; filterStatus = ''; filterPriority = ''; search = ''" class="mt-3 text-sm text-indigo-600 hover:text-indigo-700 font-medium transition-colors">
                        Clear all filters
                    </button>
                </div>
